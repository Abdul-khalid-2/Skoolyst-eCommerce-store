  ...
  <div class="form-card">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <div class="mb-2"><img data-file-preview src="<?= clean(media_url($store['logo'])) ?>" alt="" style="width:64px;height:64px;border-radius:12px;object-fit:cover;<?= $store['logo'] ? '' : 'display:none' ?>"></div>
