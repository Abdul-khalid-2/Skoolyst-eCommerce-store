...
<div class="auth-wrapper">
  <div class="auth-sidebar">
    <a href="<?= url('') ?>" class="text-decoration-none mb-4 d-inline-block">
      <div class="footer-brand" style="font-size:1.5rem">Skoolyst<span class="brand-accent">Store</span></div>
    </a>
    ...
    <?php endif; ?>
    <div class="mt-auto small text-white-50 pt-4">&copy; <?= date('Y') ?> Skoolyst Store</div>
  </div>
  <div class="auth-main">
